    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_relation', models.PositiveSmallIntegerField(choices=[(1, 'Parent'), (2, 'Child')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nature_of_job', models.CharField(max_length=15, validators=[functools.partial(user.validators.number_validator, *(), **{'length': 15})])),
                ...
                ('gender_preference', models.PositiveSmallIntegerField(choices=[(1, 'Male'), (2, 'Female'), (3, 'Any')])),
            ],
        ),
    ]
